...
public class DatabaseHelper extends SQLiteOpenHelper implements BaseColumns {
    ...
    private static final String DATABASE_CREATE_SCRIPT = "create table "
            ...
            + " integer primary key autoincrement, " + CONTACT_NAME_COLUMN + " text, "
    ...
    public void updateCallsDataBase(){
        ...
        Call lastCallInDB = new Call(contactName, phNumber, Call.CallType.valueOf(callType), callDayTime, callDuration);
        Log.d(TAG, "updateCallsDataBse: last call was " + lastCallInDB.toString());

        List<Call> calls = CallsStatisticProvider.getCallsListAfterConcreteCall(mContext, lastCallInDB);
